...
public class CreditCard
{
    ...
    */
    public void payment(double amount)
    {
        balance = balance - amount;        // TODO #1: You should subtract amount from balance variable in this function
    }
    ...
    */
    public void purchase(double amount)
    {
        balance = balance + amount;        // TODO #2: You should add amount to the balance variable in this function
    }
    ...
    */
    public double getBalance()
    {
        return balance;        // TODO #3: You should return the instance variable balance in this function
    }
}
