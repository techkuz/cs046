...
public class GradeBook
{
    ...
    {   
        ...
        if(totalForStudent(studentIndex) > 10)
        {
             comment = "Dear " + studentName + ", your total grades " + totalForStudent(studentIndex) + 
             " are OK. Keep up the good work in next semester!";
        }
        else
        {
            comment = "Dear " + studentName + ", your total grades " + totalForStudent(studentIndex) + 
             " are not very good. Please improve your work in next semester!";
        }
