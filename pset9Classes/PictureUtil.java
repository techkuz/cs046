...
public class PictureUtil
{
    ...
    public static Picture grayAndFlipLeftToRight( Picture pic)
    {
        ...
        {   
            int temp;
            for(int x = 0; x < pixels[0].length / 2; x++)
            {   
                temp = pixels[y][pixels[0].length - x];
                pixels[y][x] = pixels[y][pixels[0].length - x];
                pixels[y][pixels[0].length - x] = temp;
            }
        }
    ...
    public static Picture grayAndRotate90( Picture pic)
    {
        ...
        for(int y = 0; y < pixels[0].length; y++)
        {
            ...
            {
                pixelsRotate[x][pixels.length - 1 - y] = pixels[y][x]; 
            }
        }
        ...
        return coolPic;
         ...
         //just so draft will compile. You will change it in the final
